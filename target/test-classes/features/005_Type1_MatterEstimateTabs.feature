...
#==========================================================================================================================
Feature: Type 1 Estimate Related test Scenarios
...
#Tags to executes
#----------------------------------------------------------------------------------------------------------------------------
  @SanitySuite @Estimate @Type1_CreateNewEstimate
...
#Tags to executes
#----------------------------------------------------------------------------------------------------------------------------
  @SanitySuite @Estimate @EstimateTabs_Type1
...
#Tags to executes
#========================================================================================================================
  @SanitySuite @Estimate @MarginColor_Type1
